    ...
    def _define_target(self):
        ...
        if n_variables == 1:
            ...
            if self.mode == 'train':
                ...
                return n_targets, n_variables, [x_train / range_x_train], [f0_train], f_normalization_train, [range_x_train], self.maximal_size, [yder_train, ysec_train]
            else:
                return n_targets, n_variables,  [x_test/range_x_test], [f0_test], f_normalization_test, [range_x_test], self.maximal_size, [yder_test, ysec_test]
        # ------------------------------------------------#
        elif n_variables == 2:
            ...
            if self.mode == 'train':
                ...
                return n_targets, n_variables, [X_train/range_x_train, Y_train/range_y_train], f0_train, f_normalization_train, [range_x_train, range_y_train], self.maximal_size
            else:
                return n_targets, n_variables, [X_test/range_x_test, Y_test/range_y_test], f0_test, f_normalization_test, [range_x_test, range_y_test], self.maximal_size
        ...
        # ------------------------------------------------#
            ...
            #return n_targets, n_variables, [X_train/range_x, Y_train/range_y, Z_train/range_z], [X_test/range_x, Y_test/range_y, Z_test/range_z], [f0_train], [f0_test], f_normalization, [range_x, range_y, range_z]
                return n_targets, n_variables, [X_train / range_x_train, Y_train / range_y_train, Z_train / range_z_train], f0_train, f_normalization_train, [range_x_train, range_y_train, range_z_train], self.maximal_size
            else:
                return n_targets, n_variables, [X_test/range_x_test, Y_test/range_y_test, Z_test/range_z_test], f0_test, f_normalization_test, [range_x_test, range_y_test, range_z_test], self.maximal_size
